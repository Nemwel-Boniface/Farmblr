...
urlpatterns = [
    ...
    path('validateEmail', csrf_exempt(views.validateEmail), name="validateEmail"),
    path('validatePassword', csrf_exempt(views.validatePassword), name="validatePassword"),
    path('validateMobile', csrf_exempt(views.validateMobile), name='validateMobile'),
